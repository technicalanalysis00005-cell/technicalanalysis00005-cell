...
Data engineer in **Kyoto, Japan**. I turn messy data into useful pipelines.

---

## What I Do

- **Data Pipelines** — ETL, scraping, transformation, storage
- **Automation** — Scheduled jobs, monitoring, alerting
- **CLI Tools** — Small, focused utilities that solve one problem well
- **Analysis** — Pandas, notebooks, visualization
